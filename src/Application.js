...
const Application = () => {
    ...
    const [isTryAgainButtonDisable, setIsTryAgainButtonDisable] = useState(false);
    ...
    useEffect(() => {
        if(showResultScreen) {
            setIsTryAgainButtonDisable(true);
            setTimeout(() => {
                setIsTryAgainButtonDisable(false);
            }, 1000)
        }
    }, [showResultScreen])
        ...
        return (
            <View style={{flex: 1, justifyContent: 'space-between',}}>
                ...
                <View style={{alignSelf: 'center', }}>
                    <TouchableOpacity 
                        disabled={isTryAgainButtonDisable}
                        onPress={onClickStart}
